  ...
  return (
    <div className="flex h-screen w-full">
      <div className="flex h-screen w-full flex-col items-center justify-center px-8 md:flex-row">
        <h1 className="text-8xl font-bold text-slate-300 sm:pt-10 md:hidden md:flex-col">
          404
        </h1>
        ...
        <Image
          src={notfoundImage}
          alt="Notfound Image"
          className=" sm:3/5 w-4/5 md:w-2/6 lg:w-2/5"
        />
        <div className="md:ps-18 flex flex-col items-center justify-center px-8 py-8 md:w-3/5 md:items-start md:ps-16 lg:w-2/5">
          ...
          <h1
            className={`${spicyRice.className} text-3xl font-bold md:text-5xl`}
          >
            Uh-Oh!
          </h1>
          <p className="sm:text-md my-3 text-center text-sm sm:w-3/5 md:w-full md:text-start md:text-lg">
